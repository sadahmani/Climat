...
def train_procedure (data_gener_method, train_set_label, do_train=False, test_set_label=None,
    ...
    if lp_nathist_filtering :
        abs_min4minloss,loss_min_limit,loss_max_limit = 1e-4,0.015,0.13
    else:
        abs_min4minloss,loss_min_limit,loss_max_limit = 1e-4,0.018,0.13
    ...
    return base_cases_list, sub_cases_list
