...
def get_source_data_dir(dirname='data_source_pl', verbose=False):
    import os
    
    # Repertoire des donnees
    try:
        # WORK dir carlos projet ryn sur Jean Zay
        data_dir = f'/gpfswork/rech/ryn/uvc15wk/Data/constantin_data/{dirname}'
...
def load_basic_data_and_gener_df (models=None, forcings=None, to_filter=None, filtering_dic_filename=None, 
    ...
    if load_forcing_files :
        ...
        for iforcing,forcing in enumerate(forcings) :
            ...
            current_t_array_filename = f"T_{forcing.lower()}_{data_indent_version}.p"
...
def associated_test_label(data_and_training_label) :
    ...
    if dgen_Npc_particle == 'N132_v4' :
        test_N_part = 'NMx100_v4'
        
    elif dgen_Npc_particle == 'N1000_v4' :
        test_N_part = 'NMx1000_v4'
...
def retrieve_param_from_base_case(base_case_label, verbose=False) :
    ...
    try :
        # should begin with 'out_v5_nn' exactly
        if 'v4' not in splitedunder_for_data_label :
    ...
    v_ipos = splitedunder_for_data_label.index('v4')
